...
* ![nika_github](image.png) — главная страница репозитория NIKA на GitHub.
* ![docker_desktop_containers](image-1.png) — список контейнеров в Docker Desktop.
* ![sc-web](image-3.png) — страница SC-web ([http://localhost:8000](http://localhost:8000)).
* ![web UI](image-2.png) — диалоговый UI ([http://localhost:3033](http://localhost:3033)).
